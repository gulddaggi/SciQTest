...
import com.guld.sciq.question.service.QuestionCommentService;
...
@Tag(name = "Question Comment", description = "Question Comment 관련 APIs")
@RestController
...
public class QuestionCommentController {
    ...
    public ResponseEntity<?> updateComment(
            ...
            @RequestBody QuestionCommentCreateDto updateDto,
            @AuthenticationPrincipal UserPrincipal userPrincipal) {
        return ResponseEntity.ok(ApiUtils.success(
